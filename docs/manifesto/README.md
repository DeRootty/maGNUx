...
Esta sección declara el sentido del proyecto, su hipótesis central y la legitimidad conceptual de maGNUx.
...
```text
manifiesto
→ define por qué existe maGNUx
→ formula la soberanía sistémica
→ abre el paso hacia arquitectura e identidad
```
