...
Símbolos activados en RISC-V pero no en x86_64:> [inicio](README.md)
...
```
---
# Bruto total (más de 21k4 lineas)

[Ir al siguiente punto](#formulaConceptual10)

# Linux 6.18.25 — CONFIG_* comentados por orden alfabético

Este directorio divide la tabla completa de símbolos `CONFIG_*` en archivos Markdown más pequeños para que GitHub pueda renderizarlos correctamente.

Total de símbolos: **21402**

## Índice alfabético

| Bloque | Archivo | Símbolos |
|---|---|---:|
| 0-9 | [CONFIG-0-9.md](CONFIG-0-9.md) | 69 |
| A | [CONFIG-A.md](CONFIG-A.md) | 1667 |
| B | [CONFIG-B.md](CONFIG-B.md) | 588 |
| C | [CONFIG-C.md](CONFIG-C.md) | 1934 |
| D | [CONFIG-D.md](CONFIG-D.md) | 1361 |
| E | [CONFIG-E.md](CONFIG-E.md) | 323 |
| F | [CONFIG-F.md](CONFIG-F.md) | 623 |
| G | [CONFIG-G.md](CONFIG-G.md) | 451 |
| H | [CONFIG-H.md](CONFIG-H.md) | 685 |
| I | [CONFIG-I.md](CONFIG-I.md) | 1252 |
| J | [CONFIG-J.md](CONFIG-J.md) | 82 |
| K | [CONFIG-K.md](CONFIG-K.md) | 286 |
| L | [CONFIG-L.md](CONFIG-L.md) | 395 |
| M | [CONFIG-M.md](CONFIG-M.md) | 1631 |
| N | [CONFIG-N.md](CONFIG-N.md) | 941 |
| O | [CONFIG-O.md](CONFIG-O.md) | 190 |
| P | [CONFIG-P.md](CONFIG-P.md) | 1724 |
| Q | [CONFIG-Q.md](CONFIG-Q.md) | 166 |
| R | [CONFIG-R.md](CONFIG-R.md) | 1040 |
| S | [CONFIG-S.md](CONFIG-S.md) | 3429 |
| T | [CONFIG-T.md](CONFIG-T.md) | 667 |
| U | [CONFIG-U.md](CONFIG-U.md) | 705 |
| V | [CONFIG-V.md](CONFIG-V.md) | 594 |
| W | [CONFIG-W.md](CONFIG-W.md) | 160 |
| X | [CONFIG-X.md](CONFIG-X.md) | 353 |
| Y | [CONFIG-Y.md](CONFIG-Y.md) | 14 |
| Z | [CONFIG-Z.md](CONFIG-Z.md) | 72 |

## Uso recomendado

Sube este directorio completo a tu repositorio, por ejemplo en:

```text
docs/kernel-config/linux-6.18.25/
```

Después enlaza este `README.md` desde el README principal de maGNUx:

```md
[Tabla CONFIG_* Linux 6.18.25 comentada](docs/kernel-config/linux-6.18.25/README.md)
```

> Nota: los comentarios son orientativos. Para exactitud documental, cada símbolo debe cruzarse con su entrada `Kconfig` y el bloque `help` del árbol fuente original.

[Ir al punto anterior](#scriptUnicoTodo9)

---
<a id="formulaConceptual10"></a>
